...
var SimpleAnnotationServerV2Adapter = /*#__PURE__*/function () {
  ...
  SimpleAnnotationServerV2Adapter.createV2Anno = function createV2Anno(v3anno) {
    ...
    var v2anno = {
      ...
      on: {
        ...
        full: v3anno.target.source.id || v3anno.target.source  // **** gsdlmod that takes care of simplied record stucture that can occur
      }
    ...
    if (v3anno.target.selector) {
      ...
      //console.log("***** SimpleAnnotationSererV2Adpater-es::createV2Anno(v3anno)");
      //console.log("Given v3anno:");      
      //console.log(v3anno);
  ...
  SimpleAnnotationServerV2Adapter.createV3Anno = function createV3Anno(v2anno) {
    ...
    if (v2target.within) {
      ...
      //console.log("***** SimpleAnnotationSererV2Adpater-es::createV3Anno(v2anno) returning v3anno:");
      //console.log(v3anno);
